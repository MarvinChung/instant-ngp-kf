...
// My function: visualize_map_point
void visualize_map_point(ImDrawList* list, const Matrix<float, 4, 4>& world2proj, const Eigen::Vector3f map_point, uint32_t col) {
