...
public:
	...
	void visualize_raycasting_triangulation_map_points(ImDrawList* list, const Eigen::Matrix<float, 4, 4>& world2proj);	
	...
	struct Nerf {
		...
		std::vector<Eigen::Vector3f> raycasting_triangulation_map_points_positions;
		...
		bool visualize_raycasting_triangulation_map_points = false; 
